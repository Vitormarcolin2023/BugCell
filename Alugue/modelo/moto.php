  ...
  <body data-home-page="Página-Inicial.html" data-home-page-title="Página Inicial" data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="pt"><header class="u-clearfix u-header u-header" id="sec-e6f4"><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
          ...
          <div class="u-nav-container">
            <ul class="u-nav u-unstyled u-nav-1"><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="http://localhost/BugCell/acesso/inico.html" style="padding: 10px 20px;">Página Inicial</a>
</li></ul>
          </div>
          <div class="u-nav-container-collapse">
            <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
              <div class="u-inner-container-layout u-sidenav-overflow">
                ...
                <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="http://localhost/BugCell/acesso/inico.html">Página Inicial</a>
</li></ul>
              </div>
            </div>
                ...
                <div class="u-layout-row">
                  <div class="u-container-style u-layout-cell u-left-cell u-size-30 u-layout-cell-1" src="">
                    <div class="u-container-layout u-valign-middle u-container-layout-1">
                      <img class="custom-expanded u-image u-image-1" src="images/moto.jpg" data-image-width="500" data-image-height="500">
                    </div>
                  </div>
                  ...
                  <div class="u-align-left u-container-style u-layout-cell u-right-cell u-size-30 u-layout-cell-2">
                    <div class="u-container-layout u-container-layout-2">
                      <?php
                        include("conexao.php");
                        $query = mysqli_query($conexao, "SELECT modelo_cod, modelo_modelo, modelo_marca FROM tb_modelos WHERE modelo_cod = 10");
                        $registro = $query;
                      ...
                      <p class="u-text u-text-4">Tela Touchscreen de 6.5 polegadas. A resolução também: 1600x720 pixel. Memória interna de 64 GB com a possibilidade de expansão. Câmera de 16 megapixels com resolução de 4619x3464 pixels e gravar vídeos em (Full HD) com uma resolução de 1920x1080 pixels.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="u-layout-row">
                <div class="u-container-style u-layout-cell u-size-30 u-layout-cell-3">
                  <div class="u-container-layout u-container-layout-3">
                    ...
                    <select class="u-text u-text-default u-text-7" name="plano"required>
                      ...
                      <?php
                        include("conexao.php");
                        $query = mysqli_query($conexao, "SELECT planos_cod, planos_modelocod, planos_descricao, planos_valor, planos_duracao FROM tb_planos WHERE planos_modelocod = 10");
                        $registro2 = $query;
                    ...
                    <p class="u-text u-text-default u-text-8">Valor:<br>
                    </p>
                    <p class="u-text u-text-default u-text-9">Duração:<br>
                    </p>
                ...
                <div class="u-container-style u-layout-cell u-size-30 u-layout-cell-4">
                  <div class="u-container-layout u-valign-bottom u-container-layout-4">
                    ...
                    <button type="submit" class="u-border-none u-btn u-btn-round u-button-style u-hover-palette-2-light-1 u-palette-2-base u-radius-6 u-btn-1">REALIZAR ALUGUEL</button>
                  </div>
                </div>
              </div>
            </div>
